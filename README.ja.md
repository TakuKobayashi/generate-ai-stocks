...
| プロジェクト                                                               | 説明                                                                                                                                                                               | status     |
| -------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- |
| [ai-agent-demo-genarator](./projects/ai-agent-demo-genarator/)             | GitHubのIssueをトリガーにAIがコードを修正してPRを自動作成するイベント駆動パイプライン。                                                                                            | incubating |
...
| [medicine-manager-app](./projects/medicine-manager-app/)                   | お薬手帳アプリ                                                                                                                                                                     | incubating |
