...
| [devops-ai-agent](./projects/devops-ai-agent/)                             | An event-drivenパイプライン that triggers GitHub’s Issue to automatically create PR by specifying the code。                                                                                                    | incubating |
