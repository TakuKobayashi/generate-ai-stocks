...
| [ar-timecapsule](./projects/ar-timecapsule/)                                       | Monorepo for an AR time capsule platform combining location-based services, augmented reality experiences, and coupon distribution.                                                  | incubating |
| [attention-intervention-system](./projects/attention-intervention-system/)         | An Android app that keeps daily goals visible on the lock screen and reinforces them when the screen turns on.                                                                       | incubating |
...
| [fullstack-media-converter](./projects/fullstack-media-converter/)                 | Fullstack Media Converter is a browser-based platform for batch file conversion, supporting images, videos, and documents with no uploads.                                           | incubating |
| [generate-backup-working-tool-logs](./projects/generate-backup-working-tool-logs/) |                                                                                                                                                                                      | incubating |
...
| [kayaba-broadway](./projects/kayaba-broadway/)                                     | Online marketplace for buying digital content while walking around a virtual 3D map, built with Cloudflare Workers, Hono, Angular, PixiJS, LiveKit, and PartyKit.                    | incubating |
...
| [passport-nft](./projects/passport-nft/)                                           | Passport and border-entry stamp management system on Solana, with a React/Vite frontend and Cloudflare Workers API using Hono, D1, and Drizzle ORM.                                  | incubating |
